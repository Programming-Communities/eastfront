...
export default function BooksPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white dark:from-gray-950 dark:via-black dark:to-gray-900">
      {/* Hero Section */}
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-red-500/5 via-transparent to-blue-500/5" />
        <div className="container mx-auto px-4 pt-20 pb-16 relative">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6">
              <span className="bg-linear-to-r from-red-600 via-orange-600 to-amber-600 dark:from-red-400 dark:via-orange-400 dark:to-amber-400 bg-clip-text text-transparent">
                {t('title')}
              </span>
            </h1>
      ...
      <div className="container mx-auto px-4 pb-20">
              ...
              {paginatedFolders.map((folder, index) => (
                ...
                >
                  <div className="relative h-full p-6 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-600 transition-all duration-500 overflow-hidden shadow-lg hover:shadow-2xl">
                    {/* Background Gradient */}
                    <div className={`absolute inset-0 bg-linear-to-br ${folder.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500 rounded-2xl`} />
                    
                    {/* Featured Badge */}
                    {folder.featured && (
                      <div className="absolute -top-2 -right-2 z-10">
                        <div className="px-3 py-1 bg-linear-to-r from-yellow-600 to-orange-600 rounded-full text-xs font-bold text-white flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className={`relative p-4 rounded-xl bg-linear-to-br ${folder.color} shadow-lg`}>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center gap-2 mt-8">
                <button
                  ...
                  className="p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 disabled:opacity-50 disabled:cursor-not-allowed hover:border-red-500 transition-colors"
                >
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                  <button
                    ...
                    className={`w-10 h-10 rounded-lg transition-all ${
                      currentPage === page
                        ? 'bg-linear-to-r from-red-600 to-orange-600 text-white'
                        : 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-red-500'
                    }`}
                  >
                    {page}
                  </button>
            ...
            {featuredBooks.map((book, index) => (
              ...
              >
                <div className="relative h-full p-6 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-600 transition-all duration-500 shadow-lg hover:shadow-2xl">
                  {/* Book Cover */}
                  <div className={`mb-6 p-6 rounded-xl bg-linear-to-br ${book.color} flex items-center justify-center shadow-xl`}>
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-linear-to-r from-red-600 to-red-800 rounded-xl text-white text-sm font-medium hover:from-red-700 hover:to-red-900 transition-all group/btn">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="relative p-8 rounded-2xl bg-linear-to-r from-red-50 to-orange-50 dark:from-gray-900/50 dark:to-black/50 border border-red-100 dark:border-white/5 overflow-hidden">
            {/* Background Pattern */}
        ...
        >
          {/* Quick Stats */}
          <div className="p-6 rounded-2xl bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-500/10 dark:to-cyan-500/10 border border-blue-100 dark:border-blue-500/20">
          ...
          {/* Languages */}
          <div className="p-6 rounded-2xl bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-500/10 dark:to-emerald-500/10 border border-green-100 dark:border-green-500/20">
            <div className="flex items-center gap-4 mb-4">
          ...
          {/* Last Update */}
          <div className="p-6 rounded-2xl bg-linear-to-br from-purple-50 to-pink-50 dark:from-purple-500/10 dark:to-pink-500/10 border border-purple-100 dark:border-purple-500/20">
            <div className="flex items-center gap-4 mb-4">
